...
#    'C++ STL'      => 'g++ -std=c++11 -O3 cpp/benchmark.cpp -DREGEX_NAMESPACE=std -lboost_regex -o cpp/bin/benchmark-stl', # No case insensitive groups
...
#    'C# Mono'      => 'mcs csharp/Benchmark.cs -out:csharp/bin-mono/benchmark.exe -debug- -optimize',
    ...
    'C# .Net Core Compiled' => 'dotnet build csharp_compiled/benchmark.csproj -c Release',
...
#    'C++ STL'      => 'cpp/bin/benchmark-stl',  # No case insensitive groups
...
#    'C# Mono'      => 'mono -O=all csharp/bin-mono/benchmark.exe',
    ...
    'C# .Net Core Compiled' => 'dotnet csharp_compiled/bin/Release/net5.0/benchmark.dll',
...
#    'Dart Native'  => 'dart/bin/benchmark',  # No case insensitive groups
    'Go'           => 'go/bin/benchmark',
    'Java'         => 'java -XX:+UnlockExperimentalVMOptions -XX:+UseEpsilonGC -classpath java Benchmark',
#    'Javascript'   => 'node javascript/benchmark.js',  # No case insensitive groups
